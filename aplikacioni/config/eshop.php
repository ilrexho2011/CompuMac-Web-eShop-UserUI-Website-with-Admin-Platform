...
$config['system_modules'] = [
    ...
    'category_order' =>  array('create', 'read', 'update', 'delete'),
    ...
    'attribute' => array('create', 'read', 'update'),
    'attribute_set' => array('create', 'read', 'update'),
    'attribute_value' => array('create', 'read', 'update'),
    'product_faqs' => array('create', 'read', 'update', 'delete'),
    'flash_sale' =>  array('create', 'read', 'update', 'delete'),
    'point_of_sale' =>  array('create', 'read'),
    'media' => array('create', 'read', 'delete'),
    'home_slider' => array('create', 'read', 'update', 'delete'),
    'offer' => array('create', 'read', 'update', 'delete'),
    'offer_slider' => array('create', 'read', 'update', 'delete'),
    'offer_section_order' => array('read', 'update'),
    'manage_stock' => array('create', 'read', 'update', 'delete'),
    'chat' => array('create', 'read', 'update', 'delete'),
    ...
    'featured_section_order' => array('read', 'update'),
    'customers' => array('read', 'update'),
    'customers_transactions' => array('read', 'update'),
    'return_request' => array('create', 'read', 'update', 'delete'),
    'delivery_boy' => array('create', 'read', 'update', 'delete'),
    'fund_transfer' => array('create', 'read'),
    'manage_cash' => array('create', 'read', 'update', 'delete'),
    'payment_request' => array('create', 'read', 'update', 'delete'),
    'send_notification' => array('create', 'read', 'delete'),
    'custom_notifications' => array('create', 'read', 'update', 'delete'),
    'settings' => array('create', 'read', 'update', 'delete'),
    'store_settings' => array('create', 'read', 'update', 'delete'),
    'email_settings' => array('create', 'read', 'update', 'delete'),
    'payment_methods_settings' => array('create', 'read', 'update', 'delete'),
    'shipping_settings' => array('create', 'read', 'update', 'delete'),
    'time_slot_settings' => array('read', 'update', 'delete'),
    'notification_setting' => array('create', 'read', 'update'),
    'authentication_settings' => array('create', 'read', 'update', 'delete'),
    'sms_gateway_settings' => array('read'),
    'privacy_policy' => array('create', 'read', 'update', 'delete'),
    'return_policy' => array('create', 'read', 'update', 'delete'),
    'shipping_policy' => array('create', 'read', 'update', 'delete'),
    'admin_policies' => array('create', 'read', 'update', 'delete'),
    'delivery_boy_policies' => array('create', 'read', 'update', 'delete'),
    'client_api_keys' => array('create', 'read', 'update', 'delete'),
    'web_settings' => array('create', 'read', 'update', 'delete'),
    'pickup_location' => array('create', 'read', 'update', 'delete'),
    'reports' => array('create', 'read', 'update', 'delete'),
    ...
    'profile' => array('create', 'read', 'update', 'delete'),
];

    ...
    public function update_system_settings()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (isset($cityWiseDeliverability)) {
                $this->form_validation->set_rules('global_delivery_charge_on_city', 'Global delivery charge on City', 'trim|required|xss_clean');
                $this->form_validation->set_rules('global_free_delivery_amount_on_city', 'Global Free Delivery Amount on City', 'trim|required|xss_clean');
            }

...
class Webhook extends CI_Controller
{
    ...
    public function validateSignature($body, $secret, $MyFatoorah_Signature)
    {
        ...
        // 3- Encrypt the string using HMAC SHA-256 with the secret key from the portal in binary mode.
        //Generate hash string
        $result = hash_hmac('sha256', $orderedData, $secret, true);

        // 4- Encode the result from the previous point with base64.
        ...
        // 5- Compare the signature header with the encrypted hash string. If they are equal, then the request is valid and from the MyFatoorah side.

...
class Language extends CI_Controller
{
    ...
    public function create()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $this->form_validation->set_rules('language', 'Language', 'trim|required|xss_clean|strtolower|alpha|is_unique[languages.language]|strtolower', array('is_unique' => 'This Language already exists.'));
    ...
    public function save()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            foreach ($data as $key => $value) {
                ...
                $label_data = stripslashes($label_data);
                $label_key = $key;
                $label_data = str_replace('"', '\"', $label_data);
            ...
            $is_rtl = $this->input->post('is_rtl', true);
